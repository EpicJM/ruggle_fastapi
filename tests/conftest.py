...
# WARNING: Ensure imports from `ruggle_fastapi` comes after this line
from ruggle_fastapi import app, settings, db  # noqa
from ruggle_fastapi.cli import create_user, cli  # noqa

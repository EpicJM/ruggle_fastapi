...
description = """
ruggle_fastapi API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="ruggle_fastapi",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://ruggle_fastapi.com/terms/",
    contact={
        "name": "EpicJM",
        "url": "http://ruggle_fastapi.com/contact/",
        "email": "EpicJM@ruggle_fastapi.com",
    },
    license_info={
        "name": "The Unlicense",
